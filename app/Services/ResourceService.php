...
final class ResourceService
{
    ...
    {
        foreach (['topic_id', 'duration_minutes', 'project_id', 'study_log_id', 'checkpoint_id', 'mistake_id', 'review_schedule_id', 'planned_minutes', 'pause_minutes', 'actual_minutes'] as $field) {
